...
while True:
	...
	print("Greetings, let's play a game.")
	prompt = 'Choose your next step carefully'
	...
	print("I'm thinking of a number between " +str(min_number) + " and " +str(max_number))
