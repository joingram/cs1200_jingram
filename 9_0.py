...
class User():
    ...
    def describe_user(self):
        print('first name' + self.first + " last name = " + self.last + " Username " + self.username)
        
    def greet_user(self):
        print("Hello, " + self.first.title() + ", welcome.")
        
someuser = User('Jon', 'Ingram', 'Chief')
someuser.describe_user()
someuser.greet_user()

user2 = User('Josh', 'Gordon', "Josgor")
user2.describe_user()
user2.greet_user()

user3 = User('Phillip', 'Engel', "Aorri")
user3.describe_user()
user3.greet_user()
